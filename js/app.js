        ...
        h.forEach((x, j) => {
            if (r === "記録") {
                if (j === 4) { 
                    ...
                    s += `<td style="width: 100px; padding: 2px;">
            <div style="display: flex; align-items: center; justify-content: center; gap: 3px;">
                <input type="number" id="i4_min" onchange="U()" placeholder="分" 
                       style="width: 42px; height: 28px; padding: 0; box-sizing: border-box; text-align: center; font-size: 14px;">
                <span style="font-weight: bold; line-height: 28px;">:</span>
